 ...
 */
export async function sendToDen(url, node) {
        ...
        if ('query' in node && 'answer' in node) {
            ...
            try {
                ...
                if (hasEnoughContent) {
                    ...
                    const answerResult = await get_answer(denPages, // URLs only from den pages (what user added)
...
//# sourceMappingURL=send_toDen.js.map