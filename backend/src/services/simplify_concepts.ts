 ...
 */
export async function simplify_concepts(concepts: Concept[]): Promise<SimplifyConceptsResponse> {
  try {
    // Validate inputs
...
`;
    ...
    const validConcepts = parsedResponse.concepts.filter((concept: any) => 
      concept && 
